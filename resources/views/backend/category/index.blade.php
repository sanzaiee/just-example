                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('tag.update',$category->id) }}" id="categoryForm{{ $category->id }}" method="POST">
                                            ...
                                            {{-- <div class="row g-2">
                                                <div class="col mb-0">
                                                <label for="flatpickr-datetime-start-{{ $category->id }}" class="form-label">Vote Start At</label>
                                                <input type="text" class="form-control" name="vote_start" placeholder="YYYY-MM-DD HH:MM" value="{{ $category->vote_start }}" id="flatpickr-datetime-start-{{ $category->id }}" />
                                            </div>
                                                <div class="col mb-0">
                                                <label for="flatpickr-datetime-end-{{ $category->id }}" class="form-label">Vote End At</label>
                                                <input type="text" class="form-control" name="vote_end" placeholder="YYYY-MM-DD HH:MM"  value="{{ $category->vote_end }}" id="flatpickr-datetime-end-{{ $category->id }}" />
                                                </div>
                                            </div> --}}
