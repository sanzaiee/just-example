                            ...
                            @foreach ($siteSettings as $siteSetting)
                                <div class="col-md-6 mb-3">
                                    ...
                                    @switch($siteSetting->field_type)
                                        @case('text')
                                            <input type="{{ $siteSetting->field_type }}" class="form-control"
                                                id="{{ $siteSetting->attribute }}" name="{{ $siteSetting->attribute }}"
                                        ...
                                        @case('textarea')
                                            <textarea class="form-control" id="summernote-{{ $siteSetting->attribute }}" name="{{ $siteSetting->attribute }}"
                                                rows="3" id="textarea1">{!! $siteSetting->value !!}</textarea>
                                        @break
